...
\begin{command}{\method \meta{method name}|(|\meta{parameter list}|)|\marg{method body}}
  ...
  calling, say,  |\pgfkeys{#1}| at the beginnig of a method, you can
...
\begin{ooclass}{signal}
  ...
  that such special things of a certain kind have happend. For
  ...
  it will continue to recieve emmissions of this signal till the end
